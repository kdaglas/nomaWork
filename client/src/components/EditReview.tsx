...
export function EditReview({ reviewData, id, setViewEdit }: ReviewProps) {
    ...
    const handleEdit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setFormData({ authorName: '', rating: parseInt('5'), comment: '' });
            fetchProducts()
    ...
    return (
            ...
            <div className="edit-box mb-4 p-4 rounded border border-warning">
                <h4>Edit a Review</h4>
                <form onSubmit={handleEdit}>
                    ...
                    <button onClick={setViewEdit} className="btn btn-outline-dark btn-sm ms-2">Close</button>
                </form>
            </div>
    )
}